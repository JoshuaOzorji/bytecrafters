		...
		<div className="sm:mx-4 md:mx-14 mt-20 mb-10">
			...
			<section className="my-16 flex justify-center ">
				{visiblePosts < posts.length && (
					<button
						className="bg-primary inline-block text-accent2 rounded py-4 font-abel text-xl px-8 hover:bg-secondary hover:text-accent delay-200 transition hover:border"
