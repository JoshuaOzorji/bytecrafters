...
const Footer = () => {
	return (
		<div className='sm:mx-4 md:mx-14 mt-8 border-t'>
			{/* MD BREAKPOINT */}
			<div className='sm:hidden md:block'>
				<div className='my-4'>
					<a href='/'>
						<Image alt='logo' src={Logo} className='w-10 h-10 cursor-pointer' />
					</a>
				</div>
			...
			<div className='sm:visible md:hidden'>
				<div className='my-4 flex flex-row justify-between items-center'>
					<Link href='/'>
						<Image alt='logo' src={Logo} className='w-9 h-9 cursor-pointer' />
					</Link>
